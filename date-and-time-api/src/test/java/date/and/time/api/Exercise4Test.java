...
public class Exercise4Test {
    ...
    public void zonedDateTimeParse() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.parse("2015-06-18T23:07:25.000", DateTimeFormatter.ISO_DATE_TIME.withZone(ZoneId.of("Asia/Tokyo")));
    ...
    public void sameInstantAs() {
        ZonedDateTime zdt = DateAndTimes.ZDT_20150618_23073050; //23 hour 7 minutes in Asia/Tokyo
        ...
        // Same instant as result different time in another zone(location)
    ...
    public void sameLocalAs() {
        ...
        //Different isntant but the same time in another zone(location)
