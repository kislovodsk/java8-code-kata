...
public class Exercise2Test {
    ...
    public void localTimeOfHourToNanoSec() {
         ...
         */
        LocalTime localTime = LocalTime.of(23, 7, 3, 100_000_000);
    ...
    public void localTimeMinusDuration() {
         ...
         */
        Duration duration = Duration.of(HOURS.toMillis(3) + MINUTES.toMillis(30) + SECONDS.toMillis(20) + 200, ChronoUnit.MILLIS);
