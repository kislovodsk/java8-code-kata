...
public class Exercise7Test extends ClassicOnlineStore {
    ...
    public void averageAge() {
        ...
        /**
         * Create {@link IntStream} with customer ages by using
         * Then calculate the average of ages by using
         */
    ...
    public void howMuchToBuyAllItems() {
         ...
         */
        LongStream priceStream = shopList.stream().flatMapToLong(shop -> shop.getItemList().stream().mapToLong(value -> value.getPrice()));
