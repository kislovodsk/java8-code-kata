...
public class Exercise2Test {
    ...
    public void mergeValues() {
         ...
         */
        BiFunction<Integer, Integer, Integer> remappingFunction = (Integer v1, Integer v2) -> v1 + v2;
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<String, Integer, Integer> remappingFunction = (String key, Integer value) -> value = value+1;
